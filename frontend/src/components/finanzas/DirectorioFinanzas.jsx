...
const DirectorioFinanzas = ({
  ...
  return (
    <div className="flex-1 bg-white p-5 md:p-6 .rounded-[2rem] shadow-sm border border-slate-200 flex flex-col min-h-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
        {cargando ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-slate-400 text-center .min-h-[200px]">
